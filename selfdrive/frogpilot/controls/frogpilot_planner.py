...
class FrogPilotPlanner:
  ...
  def update(self, carControl, carState, controlsState, frogpilotCarControl, frogpilotCarState, frogpilotNavigation, liveLocationKalman, modelData, radarless_model, radarState, frogpilot_toggles):
    ...
    v_cruise = min(V_CRUISE_UNSET, max(controlsState.vCruise, controlsState.vCruiseCluster)) * CV.KPH_TO_MS
    ...
    self.frogpilot_events.update(carState, controlsState, frogpilotCarControl, frogpilotCarState, self.lead_one.dRel, modelData, v_cruise, v_lead, frogpilot_toggles)
  ...
  def publish(self, sm, pm, toggles_updated):
    ...
    frogpilotPlan.slcSpeedLimit = self.frogpilot_vcruise.slc.target
