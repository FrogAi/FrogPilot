...
void ui_update_frogpilot_params(UIState *s, Params &params) {
  ...
  float speed_conversion = scene.is_metric ? 1.0f / MS_TO_KPH : 1.0f / MS_TO_MPH;
  ...
  scene.lane_detection_width = lane_change_customizations ? params.getFloat("LaneDetectionWidth") * distance_conversion : 2.75f;
