...
FrogPilotVisualsPanel::FrogPilotVisualsPanel(FrogPilotSettingsWindow *parent, bool forceOpen) : FrogPilotListWidget(parent), parent(parent) {
  ...
  const std::vector<std::tuple<QString, QString, QString, QString>> visualToggles {
    ...
    {"ShowSpeedLimits", tr("Show Speed Limits"), tr("<b>Show the posted speed limit as a sign in the top-left corner of the driving screen.</b><br><br>The limit comes from your selected sources, including Vision when enabled."), ""},
    {"VisionSpeedLimitDetection", tr("Vision Speed Limits (U.S.)"), tr("<b>Read U.S. speed limit signs using the road camera.</b><br><br>Requires the vision models and \"Show Speed Limits\" for display without Speed Limit Controller. Recognized numbers are mph, even when your display uses km/h. The model can misread signs and cannot determine whether a sign applies to your lane or a conditional limit is active."), ""},
