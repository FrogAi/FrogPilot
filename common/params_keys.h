...
inline static std::unordered_map<std::string, ParamKeyAttributes> keys = {
    ...
    {"CESignalSpeed", {PERSISTENT, FLOAT, "25.0", "0.0", 2}},
    {"CESlowdown", {PERSISTENT, BOOL, "1", "0", 1}},
    ...
    {"ConditionalExperimentalStatus", {CLEAR_ON_OFFROAD_TRANSITION, INT, "0", "0"}},
    {"CruiseButtonIncrement", {PERSISTENT, FLOAT, "1.0", "1.0", 2}},
    {"CruiseButtonIncrementLong", {PERSISTENT, FLOAT, "5.0", "5.0", 2}},
    {"CurvatureData", {PERSISTENT | DONT_LOG, JSON, "{}", "{}"}},
    {"CurveSpeedController", {PERSISTENT, BOOL, "1", "0", 1}},
    {"CustomAlerts", {PERSISTENT, BOOL, "0", "0", 0}},
    {"CustomCruise", {PERSISTENT, FLOAT}},
    {"CustomCruiseLong", {PERSISTENT, FLOAT}},
    ...
    {"LaneLinesWidth", {PERSISTENT, FLOAT, "0.05", "0.025", 2}},
    ...
    {"MinimumLaneChangeSpeed", {PERSISTENT, FLOAT, "8.9408", "8.9408", 2}},
    ...
    {"Offset1", {PERSISTENT, FLOAT, "2.25", "0.0", 0}},
    {"Offset2", {PERSISTENT, FLOAT, "2.25", "0.0", 0}},
    {"Offset3", {PERSISTENT, FLOAT, "2.25", "0.0", 0}},
    {"Offset4", {PERSISTENT, FLOAT, "2.25", "0.0", 0}},
    {"Offset5", {PERSISTENT, FLOAT, "4.5", "0.0", 0}},
    {"Offset6", {PERSISTENT, FLOAT, "4.5", "0.0", 0}},
    {"Offset7", {PERSISTENT, FLOAT, "4.5", "0.0", 0}},
    ...
    {"ParamsMigratedToSI", {PERSISTENT, BOOL, "1", "0"}},
    {"PathEdgeWidth", {PERSISTENT, FLOAT, "20.0", "0.0", 2}},
    {"PathWidth", {PERSISTENT, FLOAT, "0.9296", "0.9", 2}},
    {"PauseAOLOnBrake", {PERSISTENT, FLOAT, "0.0", "0.0", 1}},
    ...
    {"RoadEdgesWidth", {PERSISTENT, FLOAT, "0.025", "0.025", 2}},
    ...
    {"TetheringMode", {PERSISTENT, INT, "0", "0", 0}},
