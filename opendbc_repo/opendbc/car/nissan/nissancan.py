...
def create_lkas_hud_msg(packer, lkas_hud_msg, lat_engaged, left_line, right_line, left_lane_depart, right_lane_depart):
  ...
  values["LARGE_STEERING_WHEEL_ICON"] = 2 if lat_engaged else 0
  values["RIGHT_LANE_GREEN"] = 1 if right_line and lat_engaged else 0
  values["LEFT_LANE_GREEN"] = 1 if left_line and lat_engaged else 0
